...
function Esse:Initialize()
    ...
    if MachoCreateDui then
        ...
        DUI = MachoCreateDui("https://itsfrncsa.github.io/testNUI/my_esse_dui/ui/index.html?t=" .. GetGameTimer())
        if DUI then
            MachoShowDui(DUI)
        end
    else
        -- Standard FiveM Native Fallback
        local url = "https://itsfrncsa.github.io/testNUI/my_esse_dui/ui/index.html?t=" .. GetGameTimer()
